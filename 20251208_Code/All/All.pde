...
void drawUI() {
  ...
  String layoutName = "LINE(1)";
  if (layoutMode == 1) layoutName = "ARC240-UP(2)";
  else if (layoutMode == 2) layoutName = "ARC240-TILT(3)";
  else if (layoutMode == 3) layoutName = "ARC240-CURVE(4)";
  else if (layoutMode == 4) layoutName = "ARC240-CURVE-RADIAL(5)";
  else if (layoutMode == 5) layoutName = "ARC240-CURVE-C(6)";
  else if (layoutMode == 6) layoutName = "ARC240-RING(7)";
